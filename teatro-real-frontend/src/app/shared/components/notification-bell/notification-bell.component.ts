...
// Servicio de notificaciones (deberá existir: src/app/core/services/notification.service.ts)
...
export class NotificationBellComponent {
  ...
  onNotificationClick(notif: any): void {
    ...
    if (notif.entidadTipo === 'GUION' && notif.entidadId && this.router) {
      this.router.navigate(['/tops/editor', notif.entidadId]);
    } else if (notif.entidadTipo === 'ACTIVIDAD' && notif.entidadId && this.router) {
